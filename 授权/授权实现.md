...
​但是要使用它我们需要在 SpringSecurity 配置類先开启相关配置。
...
認証的時候也需要把權限訊息封裝到 authenticationToken 當中
...
​![[授权/附件/image-20211222110249727.png]]
...
INSERT INTO `sys_menu` VALUES (1,'部門管理','dept','system/dept/index','0','0','system:dept::list','#',NULL,NULL,NULL,NULL,0,NULL),(2,'測試','test','system/test/index','0','0','system:test::list','#',NULL,NULL,NULL,NULL,0,NULL);
UNLOCK TABLES;
...
INSERT INTO `sys_role` VALUES (1,'CEO','ceo','0',0,NULL,NULL,NULL,NULL,NULL),(2,'Coder','coder','0',0,NULL,NULL,NULL,NULL,NULL);
UNLOCK TABLES;
...
INSERT INTO `sys_user` VALUES (2,'sg','三更','$2a$10$DZZzToEibd4Yt30bMpzGW..UU40EP4cCm6aBCh7q5gbOTdgA5WyaK','0',NULL,NULL,NULL,NULL,'1',NULL,NULL,NULL,NULL,0);
UNLOCK TABLES;
...
在application.yml 中配置 mapperXML 文件的位置
